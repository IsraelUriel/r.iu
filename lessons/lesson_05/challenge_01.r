...
por lo que sus mayores aplicaciones están en la modelación de variables aleatoria que representan 
proporciones o porcentajes.

Esta función de distribución tiene dos parámetros alpha (a) y beta (b), los cuales definen la forma 
de la distribución. El promedio y la varianza se calculan como: 
E(X) = a/(a+b) Var(x) = (ab)/((a+b+1)*(a+b)^2)

1.- Grafica la densidad de la distribución Beta con parámetros a=5,b=1

2.- Mediante muestro repetitivo, muestra gráficamente que la distribución del promedio de la 
    distribución beta se aproxima a una distribución normal.

3.- Muestra que el promedio y la desviación estándar del muestreo se aproxima al promedio y error 
    estándar teóricos de la distribución de la media
"
