...
# 12 mes, 52 semenal, 365 diario, 1 anual, 4 trimestrales
...
#H0: Autocorrelación = 0
#Ha: Autocorreclación != 0

# * Autocorrelación < 0.196*
...
# La parcial se enfoca en la media de los promedios moviles -> pacf
...
# x[t] = 0.4582*x[t-1] + 0.3459*w[t-1] + w[t]
arima(x, order = c(2,1,1))
# x[t] = 0.5386*x[t-1] + 0.0542*x[t-1] + 0.2791*w + w[t]
arima(x, order = c(3,1,1))

# Mejor modelo : El que tenga el menor aic
