...
# Bar plot es un histograma para variables discretas

"Para un experimento de Bernoulli tenemos que:
    - E[X] = p
    - SD[X] = sqrt(p*(1-p))
    Nota: P = Éxito, Probabilidad = Valor Esperado
...
#Nota: dbinom: D = Densidad o masa de poblacion 
...
#Nota: rbinom: R = Random - Generar múmeros aleatorios para la funcion de distribucion  
...
# Nota: Masa para variables discreta, densidad para contunias
...
#Nota : Probabilidad Acumulada de la distribucion
#     q = cuantil
